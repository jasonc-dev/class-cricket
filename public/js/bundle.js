...
var stripe = Stripe('pk_test_51IlGJALwpUr6ODJeX1hQO5kLU2UPvAeiuaTCJYiM12FPzXuA0RwpDlJyPEPKoFxF72DcKXhMPO9Ee2U2x23wSJ9500ccqMHq8Q');

var bookCourse = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _axios.default)("/api/v1/subscriptions/checkout-session/".concat(courseId));
...
// DOM ELEMENTS
var toggleCollapse = document.querySelector('.toggle-collapse span');
var nav = document.querySelector('.nav');
var loginForm = document.querySelector('.form--login');
var signupForm = document.querySelector('.form--signup');
var logOutBtn = document.querySelector('.nav__el--logout');
var bookBtn = document.getElementById('book-course'); // onclick event on toggle Collapse span tag

toggleCollapse.onclick = function (e) {
...
if (signupForm) signupForm.addEventListener('submit', function (e) {
  ...
  (0, _auth.signup)(email, password, passwordConfirm);
});
